% Close loop control program for Mahi Exoskeleton-II
...
% Date Created: May 7th, 2014
%--------------------------------------------------------------------------------------------------
%% Adapted from Brain Products's RDA Client for MATLAB for reading raw EEG
% signals using tcp/ip
%
% ***********************************************************************   
...
%           for sliding window
% 7/14/14 - Determine number of channels at runtime.
%--------------------------------------------------------------------------------------------------
%% ***********************************************************************   
...
function [processed_eeg, Overall_spatial_chan_avg, all_feature_vectors,GO_Probabilities, move_counts, marker_block, cloop_prob_threshold, cloop_cnts_threshold]...
                                                                                                                = BMI_Mahi_Closeloop(CloopClassifier,serial_obj)
   
% Read Classifier parameters from file performance_new variable.
%classifier_coeffs = dlmread(coeff_filename,'\t',num_header_lines,0);
classifier_channels = CloopClassifier.classchannels;    % change8
%classifier_channels = [9 10 16 17];     
...
cloop_prob_threshold = CloopClassifier.opt_prob_threshold;         % change9     
